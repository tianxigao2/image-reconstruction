...
def two_d_three_d(train_x, train_y, test_x, test_y, AMOUNT, AMOUNT_TEST, DEPTH, HEIGHT, WIDTH, TARGET_HEIGHT, TARGET_WIDTH):

    plt.imshow(test_x[0, :, :, 0])
    plt.title('raw test_x')
    plt.savefig('two_d_three_d/raw_test.png')
    ...
    plt.savefig('two_d_three_d/interim_test_2d+3d.png')
    ...
    plt.savefig('two_d_three_d/packed_interim_test_2d+3d.png')
    ...
    plt.savefig('two_d_three_d/final_test_2d+3d.png')
    plt.imshow(test_y[0, :, :, 0])
    plt.title('test_y')
    plt.savefig('two_d_three_d/test_y_2d+3d.png')
